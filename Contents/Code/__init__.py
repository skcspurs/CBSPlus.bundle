...
CATEGORIES = [
    ...
    {'category_id': 'classics', 'title': 'TV Classics'}
]
...
def Start():
    ...
    ObjectContainer.title1 = 'CBS Plus'
...
####################################################################################################
@handler('/video/cbsplus', 'CBS Plus', thumb=ICON)
def MainMenu():
